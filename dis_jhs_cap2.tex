...
\begin{equation}
    \vec{p} = q\vec{d}.
\end{equation}
\nomenclature{$\vec{p}$}{Dipole Moment}
\nomenclature{$q$}{Electric Charge}
\nomenclature{$\vec{d}$}{Electron Displacement from Rest Position}
...
\end{equation}
\nomenclature{$\vec{P}$}{Electric Polarization}
\nomenclature[1]{$\chi^{(1)}$}{Linear Susceptibility}
...
\label{eq:nonlim_pol}
\end{equation}
\nomenclature[2]{$\chi^{(n)}$}{High Order Electric Susceptibility}
...
\begin{equation}
    \vec{B} = \mu_0 \vec{H}
\end{equation}
\nomenclature[4]{$\mu_0$}{Vacuum Permeability}
...
\end{equation}
\nomenclature{\vec{D}}{Displacement Vector}
