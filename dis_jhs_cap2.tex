...
\end{figure}
Lets consider a neutral atom placed in an electric field $\vec{E}$. Initially the electric field shouldn't affect the atom, %REWRITE. The electric field does affect the atom
...
\end{equation}
Here I define the component drive by the external force as the fundamental mode of the motion of the electron and the high order terms are called second and third harmonic (later, we will apply this nomenclature for the optical mode).%REWRITE: I have defined nothing.  
